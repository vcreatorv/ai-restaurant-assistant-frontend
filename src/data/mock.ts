...
export type ChatMessage =
  ...
  | {
      ...
      /**
       * isError помечает сообщение как ошибку: stream обрыв, network fail и т.п.
       * UI рисует такие сообщения отдельной плашкой с иконкой, а технический
       * текст ошибки уходит в console для отладки.
       */
      isError?: boolean;
    };
...
export const chatHistory: ChatMessage[] = [
  {
    ...
    role: "assistant",
    text:
      "Здравствуйте, Алексей! Помогу подобрать блюда под ваше настроение, время и ограничения. Расскажите, что хотелось бы сегодня, или нажмите одну из подсказок ниже.",
    time: "14:30",
  },
  {
    id: "m1",
